...
float desired_angle1 = -4; //This is the angle in which we whant the
                         //balance to stay steady
...
void setup() {
  ...
  right_prop.attach(11); //attatch the right motor to pin 10
  left_prop.attach(10);  //attatch the left motor to pin 11
